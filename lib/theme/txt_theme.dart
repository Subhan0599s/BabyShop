...
class App_txt_theme{
  ...
  //  ************* CUSTOMIZATION LIGHT TEXT THEME *************** //

  static TextTheme lightTxtTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 62.0, fontWeight: FontWeight.bold, color: Colors.black,fontFamily: 'Poppins'),
    headlineMedium: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.w600, color: Colors.black,fontFamily: 'Poppins'),
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: Colors.black,fontFamily: 'Poppins'),

    titleLarge: const TextStyle().copyWith(fontSize: 22.0, fontWeight: FontWeight.w600, color: Colors.black),
    titleMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w700, color: Colors.black,fontFamily: 'Poppins'),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w400, color: Colors.black.withOpacity(0.5)),
